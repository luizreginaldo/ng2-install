...
module.exports = function () {
    ...
    let version = 4
    let url = 'https://github.com/erikfig/angular2-webpack-skeleton.git'
    let options = {}
    ...
    stdin.addListener('data',function(d) {
        ...
        if (version == 4 || version == 2) {
            ...
            console.log(`Aparentemente a equipe do Angular não sabe contar tão bem quanto a do PHP, isso não é minha culpa, use 2 ou 4`)
